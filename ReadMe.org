...
The place holder of ~pipeable.valueOf()~, use as an argument of ~pipeable.pipe/pipeable.map~.

The ~arguments~ of ~pipeable.pipe/pipeable.map~ can include zero or one place holder.
